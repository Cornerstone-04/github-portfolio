...
const Footer = () => {
  return (
    <footer className="2xl:absolute w-full py-6 px-3 h-[4.875rem] text-lg md:text-2xl flex justify-center items-center gap-[4rem] md:gap-[6.25rem] bottom-0 right-0 left-0 border-t border-[#5E5E5E]">
